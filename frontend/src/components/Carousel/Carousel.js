...
const Carousel = () => {
  return (
    <div className=''>
      <section className="mt-[150px] pb-5">
    <div className="container">
        <div className="row">
            ...
            <div className="col-6 text-right">
                <a className="btn btn-primary border-none mb-3 mr-1" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                    <i className="fa fa-arrow-left"></i>
                </a>
                <a className="btn btn-primary border-none mb-3 " href="#carouselExampleIndicators2" role="button" data-slide="next">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <div className="row">
                                ...
                                <div className="col-md-4 mb-3 rounded-md">
